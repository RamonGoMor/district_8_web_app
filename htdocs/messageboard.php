...
<div id="logoPic"><a title="Home" href="index.php"><img src="_images/onlylogo.png"></img></a></div>
    ...
    <div id="navBarIcons">
        ...
        <a href="#"><img title="Message board" class="navButton" src="_images/messageboard.png" alt="Message Board"/></a>
    </div>
	<div class="row" align="center">
    	<ul class="messageBoard">
		<br>                   
          <strong>. . . . . . 2018</span> Construction Projects:</strong>
<br>
<br>
<strong>. . . . . . 2018</span> News You Can Use:</strong>
<br>
                  	<br />
                    <br>
